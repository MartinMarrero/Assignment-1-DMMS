import { FormatDouble } from './tools.js';
...
export class Hurwitz extends DecisionMethod {
    Execute(table) {
        ...
        for (let optimism_degree = 0.0; optimism_degree < 1.0; optimism_degree += 0.1) {
            ...
            console.log(`${FormatDouble(Number(optimism_degree.toFixed(1)))} | ${FormatDouble(status_quo)}       | ${FormatDouble(expansion)}      | ${FormatDouble(building_hq)}        | ${FormatDouble(collaboration)}`);
        }
